...
import { Plus, Search, Filter, Users, Calendar, Loader2, DollarSign, FileText } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent className="bg-zinc-900 border-white/10">
              ...
              <SelectItem value="applications" className="text-white">Most applications</SelectItem>
            </SelectContent>
          </Select>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-center px-6 py-4 text-xs font-medium text-white/60 uppercase tracking-wider">Funding Range</th>
                <th className="text-center px-6 py-4 text-xs font-medium text-white/60 uppercase tracking-wider">Status</th>
                <th className="text-center px-6 py-4 text-xs font-medium text-white/60 uppercase tracking-wider">Source</th>
                <th className="text-center px-6 py-4 text-xs font-medium text-white/60 uppercase tracking-wider">Applications</th>
                <th className="text-center px-6 py-4 text-xs font-medium text-white/60 uppercase tracking-wider">RFPs</th>
              </tr>
            </thead>
                  ...
                  <tr key={grant.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-white/80">{grant._count?.applications || 0}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <FileText className="h-4 w-4 text-white/40" />
                        <span className="text-white/80">{grant._count?.rfps || 0}</span>
                      </div>
                    </td>
                  </tr>
                ))
