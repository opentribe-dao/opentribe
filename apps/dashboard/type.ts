...
export interface GrantFormData {
  ...
  export interface GrantEditHookReturn {
    ...
    updateResource: (i: number, field: keyof GrantFormData["resources"][0], v: string) => void;
    addScreeningQuestion: () => void;
    removeScreeningQuestion: (index: number) => void;
    updateScreeningQuestion: (i: number, f: keyof GrantFormData["screening"][0], v: string) => void;
  }