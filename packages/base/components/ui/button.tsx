...
// This component provides a fallback for cases where the main Button component
// might have compatibility issues with React 19
...
export const SafeButton = React.forwardRef<HTMLButtonElement, SafeButtonProps>(({ 
  ...
  const baseClasses = "inline-flex items-center justify-center rounded-md font-medium text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50";
