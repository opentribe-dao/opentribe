...
Before submitting, review the full participation charter which covers privacy requirements, engagement standards, and evaluation criteria.`,
    ...
    instructions: 'Rolling applications — no deadline. Each proposal is evaluated individually by the curatorial committee. Part of the 10M DOT Kusama Vision initiative from Web3 Foundation.',
  },
  {
...
Rolling applications, no deadline.`,
    ...
    instructions: 'Rolling applications — no deadline. Funding from 10M DOT pool allocated across Kusama bounty programs. Proposals evaluated on technical merit, feasibility, and ecosystem contribution.',
  },
  {
