    ...
    productionSeedGrants.map((grant) =>
      db.grant.upsert({
        ...
        update: {
          ...
          instructions: (grant as any).instructions || undefined,
          resources: [...grant.resources],
          skills: [...grant.skills],
          token: grant.token,
          totalFunds: (grant as any).totalFunds || undefined,
          minAmount: (grant as any).minAmount || undefined,
          maxAmount: (grant as any).maxAmount || undefined,
          status: grant.status,
