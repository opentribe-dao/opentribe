...
export const BountyDeadlineReminderEmail = ({
  ...
  >
    ...
    <EmailText className="mt-4">
      Your bounty <strong>"{bountyTitle}"</strong> deadline is approaching. 
      You have <strong>{daysRemaining} days</strong> to review submissions and 
    ...
    <EmailCard>
      <EmailText className="font-semibold mb-3">Bounty Status</EmailText>
    ...
    <EmailText className="text-sm">
      • Review all submissions<br />
      • Ask clarifying questions via comments<br />
      • Prepare your winner selection criteria<br />
    ...
    <EmailText className="text-sm text-white/60 text-center">
      After the deadline, we'll send you a reminder to announce winners. 
      The community is excited to see the results!
    </EmailText>
  </BaseTemplate>
);
