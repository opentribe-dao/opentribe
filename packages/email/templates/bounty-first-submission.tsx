...
export const BountyFirstSubmissionEmail = ({
  ...
  >
    ...
    <EmailCard>
      <EmailText className="mb-3 font-semibold">Submission Details</EmailText>
    ...
    <EmailButton href={viewSubmissionUrl}>Review This Submission</EmailButton>
    ...
    <EmailText className="text-center text-sm text-white/60">
      You'll continue to receive submissions until the deadline. We'll remind
      you when it's time to announce winners.
    </EmailText>
  </BaseTemplate>
);
...
BountyFirstSubmissionEmail.PreviewProps = {
  ...
  submissionPreview:
    "I have created a detailed tutorial covering wallet integration, transaction signing, and chain queries with Polkadot.js. The guide includes 10+ code examples and a sample dApp.",
  viewSubmissionUrl:
    "https://dashboard.opentribe.io/bounties/123/submissions/456",
