...
export const GrantFirstApplicationEmail = ({
  ...
  >
    ...
    <EmailText className="mt-4">
      Exciting news! Your grant <strong>"{grantTitle}"</strong> just received its 
      first application. This is a great start!
    </EmailText>

    <EmailDivider />

    <EmailCard>
      <EmailText className="font-semibold mb-3">Application Overview</EmailText>
    ...
    <EmailButton href={viewApplicationUrl}>
...
GrantFirstApplicationEmail.PreviewProps = {
  ...
  applicationSummary: 'We propose to build a decentralized lending protocol using Substrate that enables cross-chain collateral from multiple parachains. Our team has extensive experience in DeFi development and Substrate runtime engineering.',
  requestedAmount: '$30,000',
  viewApplicationUrl: 'https://dashboard.opentribe.io/grants/123/applications/456',
