...
export const VerificationEmail = ({
  ...
  <BaseTemplate preview="Verify your email address for Opentribe">
    ...
    <EmailText className="mt-4">
      Thanks for joining Opentribe, the talent marketplace for the Polkadot
      ecosystem. Please verify your email address to get started.
    </EmailText>
    ...
    <EmailText className="text-sm text-white/60">
      ...
      Opentribe, you can safely ignore this email.
    </EmailText>
  </BaseTemplate>
);
