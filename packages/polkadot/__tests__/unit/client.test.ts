...
describe('Client Unit Tests', () => {
  ...
  describe('URL Generation', () => {
    test('should generate correct Polkadot Subscan URLs', () => {
      ...
      expect(extrinsicUrl).toBe('https://polkadot.subscan.io/extrinsic/0x123abc');

      const addressUrl = client.getAddressUrl('15oF4uVJwmo4TdGW7VfQxNLavjCXviqxT9S1MgbjMNHr6Sp5');
      expect(addressUrl).toBe('https://polkadot.subscan.io/account/15oF4uVJwmo4TdGW7VfQxNLavjCXviqxT9S1MgbjMNHr6Sp5');
    });
    ...
    test('should generate correct Kusama Subscan URLs', () => {
      ...
      const addressUrl = client.getAddressUrl('CpjsLDC1JFyrhm3ftC9Gs4QoyrkHKhZKtK7YqGTRFtTafgp');
      expect(addressUrl).toBe('https://kusama.subscan.io/account/CpjsLDC1JFyrhm3ftC9Gs4QoyrkHKhZKtK7YqGTRFtTafgp');
    });
    ...
    test('should generate correct Westend Subscan URLs', () => {
      ...
      expect(extrinsicUrl).toBe('https://westend.subscan.io/extrinsic/0x789ghi');

      const addressUrl = client.getAddressUrl('5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY');
      expect(addressUrl).toBe('https://westend.subscan.io/account/5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY');
    });
